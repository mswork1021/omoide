...
const faqs: FAQItem[] = [
  ...
  {
    question: 'PDFが届きません / 開けません',
    answer:
      '画像追加（¥500）をご購入いただいた場合のみ、メールでPDFをお届けします。記事生成（¥80）のみではメール送信されません。PDFが届かない場合は、迷惑メールフォルダをご確認ください。それでも届かない場合はお問い合わせください。',
  },
  {
    question: 'メールアドレスを間違えて入力しました',
    answer:
      '申し訳ありませんが、一度決済が完了した後のメールアドレス変更はできません。画面に表示されているPDFをダウンロードして保存してください。',
  },
  {
  ...
  },
  {
    ...
    answer:
      'はい、個人利用であれば印刷可能です。高解像度PDFで出力されるため、A4サイズでの印刷に対応しています。額装してプレゼントにもご利用いただけます。',
  },
  {
  ...
  },
  {
    ...
    answer:
      'はい、可能です。大量注文や法人向けのご相談はお問い合わせページよりご連絡ください。',
  },
];
